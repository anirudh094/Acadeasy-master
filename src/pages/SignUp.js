...
//   };
  ...
  //             </div>
  //             <div className="group">
  //               <label htmlFor="pass-saved" className="label">
  //                 Password
  //               </label>
  //               <input
  //                 id="pass-saved"
  ...
  //               <input id="emailSignIn" type="email" className="input" value={emailSignIn} onChange={(o) => setEmailSignIn(o.target.value)} />
  //             </div>
  //             <div className="group">
  //               <label htmlFor="passSignIn" className="label">Password</label>
  //               <input id="passSignIn" type="password" className="input" data-type="password" value={passwordSignIn} onChange={(o) => setPasswordSignIn(o.target.value)} />
  //             </div>
  //             <div className="group">
  //               <input type="submit" className="button" value="Sign In" />
  //             </div>
